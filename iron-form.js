...
`,
  ...
  attached: function() {
    ...
    //document.registerElement('code-container', MyElement);
  ...
  //  var el2 = document.createElement('my-element');
   window.customElements.define(MyElement.is, MyElement);
      ...
      console.log("test1");
      var t=document.querySelector('.code-container');
      console.log(t);
    }
  ...
  _init: function() {
    ...
    console.log("test2");
    var t=document.querySelector('marked-element');
    //var t=dom(this).querySelector('marked-element');
    console.log(t);
  },
